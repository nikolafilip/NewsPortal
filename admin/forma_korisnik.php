<form method="post" enctype="multipart/form-data" action="" name="forma_korisnik">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="lozinka" name="lozinka" placeholder="" value="">
    </div>
    <div class="form-group">
        <label for="lozinka2">Lozinka ponovo</label>
        <input type="text" class="form-control" id="lozinka2" name="lozinka2" placeholder="" value="">
    </div>
